...
// by default every component is a server component to make it client component we have to explicitly tell the nextjs by using 'use client' to make it a client component to use the functionality like onClick, onChange etc.. 